...
def send_sms_to_raiffeisen(phone_number: str):
    try:
        ...
        print("RAIFFEISEN: ", {"status_code": responce.status_code, "response": responce.text})
        with open("logs\\RAIFFEISEN.log", "w") as file:
            file.write(f"RAIFFEISEN responce status_code: {responce}, text: {responce.text}")
        return {"status_code": responce.status_code, "response": responce.text}
