...
def startup():
    ...
    high_priority_services = [("21", 2), ("25", 1), ("26", 1), ("6", 1), ("10", 2),("17", 1),("8", 1),("9", 1), ("18", 1), ("27", 1), ("28", 1), ("29", 1), ("30", 1)]
    low_priority_services = [("22", 1), ("23", 1),("21", 1),("20", 1), ("7", 1),
                             ("11", 1), ("11", 1), ("13", 1), ("31", 1), ("32", 2),
                             ("33", 1), ("31", 1), ("35", 1), ("36", 1), ("37", 2),
                             ("38", 1)
                             ]
